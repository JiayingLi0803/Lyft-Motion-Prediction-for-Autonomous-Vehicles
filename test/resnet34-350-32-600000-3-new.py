...
if debug:
    ...
    # Only use 1000 dataset for fast check...
    valid_dataset = Subset(valid_dataset, np.arange(len(train_dataset)/10)) # need to change
...
pt_path = "/home/ubuntu/lyft-output/resnet34-350-32-600000-3-new/predictor.pt" 
...
csv_path = "resnet34-350-32-600000-3-new.csv"
write_pred_csv(
    csv_path,

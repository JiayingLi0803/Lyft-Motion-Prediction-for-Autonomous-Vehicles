...
cfg = {
    ...
    'raster_params': {
        'raster_size': [334,334], # 224*224, 300*300, 350*350, 448*448, you can give a try to set 224*224
        'pixel_size': [0.4, 0.4],
        'ego_center': [0.25, 0.5],
...
flags_dict = {
    ...
    "out_dir": "/home/ubuntu/lyft-output/resnet34-334-0.4-64-2",
    "epoch": 2, 
    "snapshot_freq": 50,
}
...
pt_path = "/home/ubuntu/lyft-output/resnet34-334-0.4-64-2/predictor.pt" 
...
csv_path = "resnet34-334-0.4-64-2.csv"
write_pred_csv(
    csv_path,
